                    ...
                    <form action="save.php" method="post">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                                ...
                                <tr>
                                    <td BGCOLOR=#E0E0E0 COLSPAN='3'><?php echo $h["name_header"]; ?></td>
                                </tr>
                                <td></td>
                                <td></td>
                                <td></td>
                                <tbody>
                                    ...
                                    if (isset($_GET['id'])) {
                                        $id = $_GET['id'];
                                        $index_h = 0;
                                        $select_stmt = $conn->prepare("SELECT s.*, q.* FROM score as s INNER JOIN form_question as q on q.id_queustion = s.id_question  WHERE id_header = $id_header AND s.id_student = $id ");
                                        $select_stmt->execute();
